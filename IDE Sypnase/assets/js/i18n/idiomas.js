(function () {
    ...
    const D = {
      'A imagem chegou corrompida': [
        'The image arrived corrupted',
        'La imagen llegó corrupta',
        '图片已损坏',
      ],
      'A imagem chegou incompleta': [
        'The image arrived incomplete',
        'La imagen llegó incompleta',
        '图片不完整',
      ],
      'A imagem é grande demais': ['The image is too large', 'La imagen es demasiado grande', '图片太大'],
      'A imagem saiu do projeto': [
        'The image left the project',
        'La imagen salió del proyecto',
        '图片已不在项目中',
      ],
      'A malha chegou ao limite': [
        'The mesh hit its limit',
        'La malla alcanzó el límite',
        '网格已达上限',
      ],
      'A operação falhou': ['The operation failed', 'La operación falló', '操作失败'],
      'A ponte precisa de dois laços': [
        'The bridge needs two loops',
        'El puente necesita dos bucles',
        '桥接需要两个环',
      ],
      Adicionar: ['Add', 'Añadir', '添加'],
      'Alinhar': ['Align', 'Alinear', '对齐'],
      'Ângulo': ['Angle', 'Ángulo', '角度'],
      'Apagar as faces da seleção (Delete)': [
        'Delete the selected faces (Delete)',
        'Borrar las caras de la selección (Delete)',
        '删除所选面（Delete）',
      ],
      'Apagar elementos': ['Delete elements', 'Borrar elementos', '删除元素'],
      Aplicar: ['Apply', 'Aplicar', '应用'],
      Aresta: ['Edge', 'Arista', '边'],
      arestas: ['edges', 'aristas', '边'],
      'Arestas não múltiplas de dois': [
        'Edges not shared by two faces',
        'Aristas no compartidas por dos caras',
        '非双面共享边',
      ],
      'As normais já apontam para fora': [
        'The normals already point outward',
        'Las normales ya apuntan hacia fuera',
        '法线已朝外',
      ],
      'Base': ['Bottom', 'Base', '底部'],
      Chanfrar: ['Bevel', 'Biselar', '倒角'],
      'Chanfrar os vértices (B)': [
        'Bevel the vertices (B)',
        'Biselar los vértices (B)',
        '倒角顶点（B）',
      ],
      'Chanfro só em vértices fechados': [
        'Bevel only on closed vertices',
        'Bisel solo en vértices cerrados',
        '仅支持封闭顶点倒角',
      ],
      'Cilíndrica': ['Cylindrical', 'Cilíndrica', '圆柱'],
      'Cor base': ['Base color', 'Color base', '基础颜色'],
      Corrigir: ['Fix', 'Corregir', '修复'],
      'Corrigir malha': ['Fix mesh', 'Corregir malla', '修复网格'],
      'Corrigir os problemas encontrados': [
        'Fix the problems found',
        'Corregir los problemas encontrados',
        '修复发现的问题',
      ],
      'Cortar o anel de quads (K)': [
        'Cut the quad ring (K)',
        'Cortar el anillo de quads (K)',
        '切割四边形环（K）',
      ],
      'Corte em anel': ['Loop cut', 'Corte en anillo', '环切'],
      Crescer: ['Grow', 'Crecer', '扩大'],
      'Crescer a seleção (])': ['Grow the selection (])', 'Crecer la selección (])', '扩大选择（]）'],
      'Criar a primitiva escolhida': [
        'Create the chosen primitive',
        'Crear la primitiva elegida',
        '创建所选基本体',
      ],
      'Ctrl+arrastar: caixa · Alt+arrastar: laço': [
        'Ctrl+drag: box · Alt+drag: lasso',
        'Ctrl+arrastrar: caja · Alt+arrastrar: lazo',
        'Ctrl+拖动：框选 · Alt+拖动：套索',
      ],
      'Cúbica': ['Cubic', 'Cúbica', '立方'],
      'Deslocar': ['Offset', 'Desplazar', '偏移'],
      'Editar malha': ['Edit mesh', 'Editar malla', '编辑网格'],
      'Eixo X': ['X axis', 'Eje X', 'X 轴'],
      'Eixo Y': ['Y axis', 'Eje Y', 'Y 轴'],
      'Eixo Z': ['Z axis', 'Eje Z', 'Z 轴'],
      'Embutir a imagem no arquivo': [
        'Embed the image in the file',
        'Incrustar la imagen en el archivo',
        '将图片嵌入文件',
      ],
      'Emissão': ['Emission', 'Emisión', '自发光'],
      Encolher: ['Shrink', 'Reducir', '缩小'],
      'Encolher a seleção ([)': [
      ...
      'Entrar ou sair da edição (Alt+E)': [
        'Enter or leave editing (Alt+E)',
        'Entrar o salir de la edición (Alt+E)',
        '进入或退出编辑（Alt+E）',
      ],
      'Entre no modo de edição para trabalhar o UV': [
        'Enter edit mode to work on the UV',
        'Entra en modo de edición para trabajar el UV',
        '进入编辑模式以处理 UV',
      ],
      'Escolha arestas': ['Pick edges', 'Elige aristas', '请选择边'],
      'Escolha duas bordas abertas': [
        'Pick two open borders',
        'Elige dos bordes abiertos',
        '请选择两条开放边界',
      ],
      'Escolha faces': ['Pick faces', 'Elige caras', '请选择面'],
      'Escolha faces ou arestas de borda': [
        'Pick faces or border edges',
        'Elige caras o aristas de borde',
        '请选择面或边界边',
      ],
      'Escolha um objeto para editar materiais': [
        'Pick an object to edit materials',
        'Elige un objeto para editar materiales',
        '选择一个对象来编辑材质',
      ],
      'Escolha uma aresta': ['Pick an edge', 'Elige una arista', '请选择一条边'],
      'Escolha uma forma para editar': [
        'Pick a shape to edit',
        'Elige una forma para editar',
        '选择要编辑的形状',
      ],
      'Escolha vértices': ['Pick vertices', 'Elige vértices', '请选择顶点'],
      'Esférica': ['Spherical', 'Esférica', '球面'],
      Espelhar: ['Mirror', 'Reflejar', '镜像'],
      'Espelhar a malha pelo eixo': [
        'Mirror the mesh across the axis',
        'Reflejar la malla por el eje',
        '沿轴镜像网格',
      ],
      Extrudar: ['Extrude', 'Extruir', '挤出'],
      'Extrudar a seleção (E)': [
        'Extrude the selection (E)',
        'Extruir la selección (E)',
        '挤出所选（E）',
      ],
      Face: ['Face', 'Cara', '面'],
      'Face dupla': ['Double sided', 'Doble cara', '双面'],
      faces: ['faces', 'caras', '面'],
      'Faces degeneradas': ['Degenerate faces', 'Caras degeneradas', '退化面'],
      'faces escolhidas': ['selected faces', 'caras elegidas', '已选面'],
      'faces fora do quadro': ['faces outside the frame', 'caras fuera del cuadro', '框外的面'],
      'faces na ilha': ['faces in the island', 'caras en la isla', '岛内的面'],
      Fator: ['Factor', 'Factor', '系数'],
      'fora da edição': ['not editing', 'fuera de la edición', '未在编辑'],
      Fundir: ['Merge', 'Fusionar', '合并'],
      'Fundir por distância': ['Merge by distance', 'Fusionar por distancia', '按距离合并'],
      'Fundir vértices por distância (M)': [
        'Merge vertices by distance (M)',
        'Fusionar vértices por distancia (M)',
        '按距离合并顶点（M）',
      ],
      'Girar a aresta entre duas faces (T)': [
        'Rotate the edge between two faces (T)',
        'Girar la arista entre dos caras (T)',
        '旋转两面之间的边（T）',
      ],
      'Girar aresta': ['Rotate edge', 'Girar arista', '旋转边'],
      'Gire arestas entre duas faces': [
        'Rotate edges between two faces',
        'Gira aristas entre dos caras',
        '请旋转两面之间的边',
      ],
      'imagem pesada para embutir': [
        'image too heavy to embed',
        'imagen pesada para incrustar',
        '图片过大不宜嵌入',
      ],
      'Informe uma distância': ['Enter a distance', 'Indica una distancia', '请输入距离'],
      'Inserir face': ['Inset face', 'Insertar cara', '内插面'],
      'Inserir face para dentro (I)': [
        'Inset the face inward (I)',
        'Insertar la cara hacia dentro (I)',
        '向内内插面（I）',
      ],
      Inverter: ['Invert', 'Invertir', '反转'],
      'Inverter a seleção (Ctrl+I)': [
        'Invert the selection (Ctrl+I)',
        'Invertir la selección (Ctrl+I)',
        '反转选择（Ctrl+I）',
      ],
      'Inverter as normais': ['Flip the normals', 'Invertir las normales', '翻转法线'],
      'Inverter normais': ['Flip normals', 'Invertir normales', '翻转法线'],
      Ligados: ['Linked', 'Conectados', '相连'],
      'Limpar a seleção': ['Clear the selection', 'Limpiar la selección', '清空选择'],
      Malha: ['Mesh', 'Malla', '网格'],
      'Malha limpa': ['Clean mesh', 'Malla limpia', '网格干净'],
      'Malha vazia': ['Empty mesh', 'Malla vacía', '网格为空'],
      'Materiais': ['Materials', 'Materiales', '材质'],
      'Metalicidade': ['Metalness', 'Metalicidad', '金属度'],
      'Mover a seleção pelos valores': [
        'Move the selection by the values',
        'Mover la selección por los valores',
        '按数值移动所选',
      ],
      'Mover seleção': ['Move selection', 'Mover selección', '移动所选'],
      Nada: ['None', 'Nada', '无'],
      'Nada para corrigir': ['Nothing to fix', 'Nada que corregir', '无需修复'],
      'Nada para cortar': ['Nothing to cut', 'Nada que cortar', '无可切割'],
      'Nada para espelhar': ['Nothing to mirror', 'Nada que reflejar', '无可镜像'],
      'Nada para extrudar': ['Nothing to extrude', 'Nada que extruir', '无可挤出'],
      'Nada para inserir': ['Nothing to inset', 'Nada que insertar', '无可内插'],
      'Nada para inverter': ['Nothing to flip', 'Nada que invertir', '无可翻转'],
      'Nada para pontear': ['Nothing to bridge', 'Nada que puentear', '无可桥接'],
      'Nada para preencher': ['Nothing to fill', 'Nada que rellenar', '无可填充'],
      'Nada para subdividir': ['Nothing to subdivide', 'Nada que subdividir', '无可细分'],
      'Nada perto para fundir': [
        'Nothing close enough to merge',
        'Nada cerca para fusionar',
        '附近无可合并',
      ],
      'Nada selecionado': ['Nothing selected', 'Nada seleccionado', '未选择任何内容'],
      'Não deu para ler a imagem': [
        'The image could not be read',
        'No se pudo leer la imagen',
        '无法读取图片',
      ],
      'Não foi possível alinhar': ['Could not align', 'No se pudo alinear', '无法对齐'],
      'Não foi possível converter em malha': [
        'Could not convert to mesh',
        'No se pudo convertir en malla',
        '无法转换为网格',
      ],
      'Nenhuma imagem no projeto': [
        'No image in the project',
        'Ninguna imagen en el proyecto',
        '项目中没有图片',
      ],
      'Nome do material': ['Material name', 'Nombre del material', '材质名称'],
      'Normais invertidas': ['Flipped normals', 'Normales invertidas', '反向法线'],
      'Normais para fora': ['Normals outward', 'Normales hacia fuera', '法线朝外'],
      'O corte precisa de um anel de quads': [
        'The cut needs a quad ring',
        'El corte necesita un anillo de quads',
        '环切需要四边形环',
      ],
      'O objeto está travado': ['The object is locked', 'El objeto está bloqueado', '该对象已锁定'],
      'Opacidade': ['Opacity', 'Opacidad', '不透明度'],
      'Os laços precisam do mesmo tamanho': [
        'The loops need the same size',
        'Los bucles necesitan el mismo tamaño',
        '两个环需要相同数量',
      ],
      'Para fora': ['Outward', 'Hacia fuera', '朝外'],
      Plana: ['Flat', 'Plana', '平直'],
      Ponte: ['Bridge', 'Puente', '桥接'],
      'Ponte de arestas': ['Edge bridge', 'Puente de aristas', '边桥接'],
      'Ponte entre duas bordas (P)': [
        'Bridge between two borders (P)',
        'Puente entre dos bordes (P)',
        '在两条边界间桥接（P）',
      ],
      'Por ângulo': ['By angle', 'Por ángulo', '按角度'],
      Preencher: ['Fill', 'Rellenar', '填充'],
      'Preencher buraco': ['Fill hole', 'Rellenar agujero', '填补孔洞'],
      'Preencher buraco (H)': ['Fill hole (H)', 'Rellenar agujero (H)', '填补孔洞（H）'],
      'Primitiva para adicionar': ['Primitive to add', 'Primitiva para añadir', '要添加的基本体'],
      Duplicar: ['Duplicate', 'Duplicar', '复制'],
      'Duplicar a seleção (Ctrl+D)': [
        'Duplicate the selection (Ctrl+D)',
        'Duplicar la selección (Ctrl+D)',
        '复制所选对象（Ctrl+D）',
      ],
      Agrupar: ['Group', 'Agrupar', '编组'],
      'Juntar a seleção em um grupo': [
        'Join the selection into a group',
        'Unir la selección en un grupo',
        '将所选对象合为一组',
      ],
      Apagar: ['Delete', 'Eliminar', '删除'],
      'Apagar a seleção (Delete)': [
        'Delete the selection (Delete)',
        'Eliminar la selección (Supr)',
        '删除所选对象（Delete）',
      ],
      Desfazer: ['Undo', 'Deshacer', '撤销'],
      'Desfazer (Ctrl+Z)': ['Undo (Ctrl+Z)', 'Deshacer (Ctrl+Z)', '撤销（Ctrl+Z）'],
      'Procurar problemas na malha': [
        'Look for mesh problems',
        'Buscar problemas en la malla',
        '检查网格问题',
      ],
      'Projete o UV para começar': [
        'Project the UV to get started',
        'Proyecta el UV para empezar',
        '先投影 UV 再开始',
      ],
      'Recalcular as normais para fora': [
        'Recalculate normals outward',
        'Recalcular las normales hacia fuera',
        '重算法线朝外',
      ],
      'Reduzir para': ['Reduce to', 'Reducir a', '缩小到'],
      Refazer: ['Redo', 'Rehacer', '重做'],
      'Refazer (Ctrl+Shift+Z)': [
        'Redo (Ctrl+Shift+Z)',
        'Rehacer (Ctrl+Shift+Z)',
        '重做（Ctrl+Shift+Z）',
      ],
      'Nada para desfazer': ['Nothing to undo', 'Nada para deshacer', '没有可撤销的操作'],
      'Nada para refazer': ['Nothing to redo', 'Nada para rehacer', '没有可重做的操作'],
      Mover: ['Move', 'Mover', '移动'],
      Escalar: ['Scale', 'Escalar', '缩放'],
      'Mover (W)': ['Move (W)', 'Mover (W)', '移动（W）'],
      'Girar (E)': ['Rotate (E)', 'Girar (E)', '旋转（E）'],
      'Escalar (R)': ['Scale (R)', 'Escalar (R)', '缩放（R）'],
      Global: ['Global', 'Global', '全局'],
      Local: ['Local', 'Local', '局部'],
      'Alternar eixo global e local (X)': [
        'Switch global and local axis (X)',
        'Alternar eje global y local (X)',
        '切换全局与局部坐标轴（X）',
      ],
      Encaixar: ['Snap', 'Ajustar', '吸附'],
      Ângulo: ['Angle', 'Ángulo', '角度'],
      Escala: ['Scale', 'Escala', '比例'],
      Posição: ['Position', 'Posición', '位置'],
      Rotação: ['Rotation', 'Rotación', '旋转'],
      Pivô: ['Pivot', 'Pivote', '轴心'],
      Parâmetros: ['Parameters', 'Parámetros', '参数'],
      Parâmetro: ['Parameter', 'Parámetro', '参数'],
      Pai: ['Parent', 'Padre', '父级'],
      'Raiz da cena': ['Scene root', 'Raíz de la escena', '场景根节点'],
      Reparentar: ['Reparent', 'Cambiar el padre', '更改父级'],
      Cena: ['Scene', 'Escena', '场景'],
      'Cena vazia': ['Empty scene', 'Escena vacía', '场景为空'],
      'Nenhum objeto selecionado': ['No object selected', 'Ningún objeto seleccionado', '未选择对象'],
      'Clique duplo para renomear': [
        'Double-click to rename',
        'Doble clic para renombrar',
        '双击可重命名',
      ],
      'Esconder o objeto': ['Hide the object', 'Ocultar el objeto', '隐藏该对象'],
      'Mostrar o objeto': ['Show the object', 'Mostrar el objeto', '显示该对象'],
      'Repetir': ['Repeat', 'Repetir', '重复'],
      'Rugosidade': ['Roughness', 'Rugosidad', '粗糙度'],
      'Selecionar o pedaço ligado (L)': [
        'Select the linked piece (L)',
        'Seleccionar la parte conectada (L)',
        '选择相连部分（L）',
      ],
      ...
      'Selecione faces no modo de edição para atribuir': [
        'Select faces in edit mode to assign',
        'Selecciona caras en modo de edición para asignar',
        '在编辑模式中选择面后再分配',
      ],
      'Sem bordas abertas': ['No open borders', 'Sin bordes abiertos', '没有开放边界'],
      'sem edição': ['not editing', 'sin edición', '未编辑'],
      'sem instalação': ['no install', 'sin instalación', '免安装'],
      'sem objeto': ['no object', 'sin objeto', '无对象'],
      'Sem textura': ['No texture', 'Sin textura', '无贴图'],
      Solda: ['Weld', 'Soldadura', '焊接'],
      'Soldar no meio': ['Weld at the middle', 'Soldar en el medio', '在中线焊接'],
      Sombreamento: ['Shading', 'Sombreado', '着色'],
      'Sombreamento já aplicado': ['Shading already applied', 'Sombreado ya aplicado', '着色已应用'],
      'Sombreamento plano': ['Flat shading', 'Sombreado plano', '平直着色'],
      'Sombreamento suave': ['Smooth shading', 'Sombreado suave', '平滑着色'],
      Suave: ['Smooth', 'Suave', '平滑'],
      'Suavizar até o ângulo escolhido': [
        'Smooth up to the chosen angle',
        'Suavizar hasta el ángulo elegido',
        '按所选角度平滑',
      ],
      Subdividir: ['Subdivide', 'Subdividir', '细分'],
      'Subdividir as faces (S)': [
        'Subdivide the faces (S)',
        'Subdividir las caras (S)',
        '细分所选面（S）',
      ],
      'Textura': ['Texture', 'Textura', '贴图'],
      'Toque numa ilha para mover, girar ou escalar': [
        'Tap an island to move, rotate or scale',
        'Toca una isla para mover, girar o escalar',
        '点按一个 UV 岛来移动、旋转或缩放',
      ],
      'Tornar editável': ['Make editable', 'Hacer editable', '转为可编辑'],
      'Travar o objeto': ['Lock the object', 'Bloquear el objeto', '锁定该对象'],
      'Destravar o objeto': ['Unlock the object', 'Desbloquear el objeto', '解锁该对象'],
      Esconder: ['Hide', 'Ocultar', '隐藏'],
      Mostrar: ['Show', 'Mostrar', '显示'],
      Travar: ['Lock', 'Bloquear', '锁定'],
      Renomear: ['Rename', 'Renombrar', '重命名'],
      'Centralizar pivô': ['Center pivot', 'Centrar el pivote', '轴心居中'],
      'Põe o pivô no centro da malha': [
        'Puts the pivot at the center of the mesh',
        'Pone el pivote en el centro de la malla',
        '把轴心放到网格中心',
      ],
      'Pivô na base': ['Pivot at the base', 'Pivote en la base', '轴心置于底部'],
      'Apoia o pivô na base da malha': [
        'Rests the pivot on the base of the mesh',
        'Apoya el pivote en la base de la malla',
        '把轴心放到网格底部',
      ],
      Seleção: ['Selection', 'Selección', '所选对象'],
      Exportar: ['Export', 'Exportar', '导出'],
      objetos: ['objects', 'objetos', '个对象'],
      passos: ['steps', 'pasos', '步'],
      Grupo: ['Group', 'Grupo', '组'],
      'A cena está vazia — nada para gravar': [
        'The scene is empty — nothing to save',
        'La escena está vacía: nada para guardar',
        '场景为空 — 没有可保存的内容',
      ],
      Esfera: ['Sphere', 'Esfera', '球体'],
      Cilindro: ['Cylinder', 'Cilindro', '圆柱体'],
      Cone: ['Cone', 'Cono', '圆锥体'],
      Plano: ['Plane', 'Plano', '平面'],
      Toro: ['Torus', 'Toro', '圆环'],
      Rampa: ['Ramp', 'Rampa', '斜坡'],
      Profundidade: ['Depth', 'Profundidad', '深度'],
      Raio: ['Radius', 'Radio', '半径'],
      Segmentos: ['Segments', 'Segmentos', '分段'],
      Anéis: ['Rings', 'Anillos', '环数'],
      'Raio do aro': ['Ring radius', 'Radio del aro', '环半径'],
      'Raio do tubo': ['Tube radius', 'Radio del tubo', '管半径'],
      Livre: ['Free', 'Libre', '自由'],
      Frente: ['Front', 'Frente', '前视图'],
      Lado: ['Side', 'Lado', '侧视图'],
      Topo: ['Top', 'Arriba', '顶视图'],
      Enquadrar: ['Fit', 'Encuadrar', '适应视图'],
      Grade: ['Grid', 'Rejilla', '网格'],
      Carregar: ['Load', 'Cargar', '加载'],
      Perspectiva: ['Perspective', 'Perspectiva', '透视'],
      Ortográfica: ['Orthographic', 'Ortográfica', '正交'],
      Distância: ['Distance', 'Distancia', '距离'],
      Alvo: ['Target', 'Objetivo', '目标'],
      Cubo: ['Cube', 'Cubo', '立方体'],
      triângulos: ['triangles', 'triángulos', '三角形'],
      'UV': ['UV', 'UV', 'UV'],
      Verificar: ['Check', 'Verificar', '检查'],
      Vértice: ['Vertex', 'Vértice', '顶点'],
      vértices: ['vertices', 'vértices', '顶点'],
      'Vértices soltos': ['Loose vertices', 'Vértices sueltos', '孤立顶点'],
      'Vista livre': ['Free view', 'Vista libre', '自由视角'],
      'Vista frente': ['Front view', 'Vista frontal', '前视图视角'],
      'Vista lado': ['Side view', 'Vista lateral', '侧视图视角'],
      'Vista topo': ['Top view', 'Vista superior', '顶视图视角'],
      Atalhos: ['Shortcuts', 'Atajos', '快捷键'],
      'Atalhos do teclado': ['Keyboard shortcuts', 'Atajos de teclado', '键盘快捷键'],
      'Mapa de teclas': ['Keymap', 'Mapa de teclas', '按键映射'],
      'Padrão do Synapse': ['Synapse default', 'Predeterminado de Synapse', 'Synapse 默认'],
      'Estilo Blender': ['Blender style', 'Estilo Blender', 'Blender 风格'],
      'Abrir a folha de atalhos': [
        'Open the shortcut sheet',
        'Abrir la hoja de atajos',
        '打开快捷键表',
      ],
      'No modo de edição valem os atalhos da malha.': [
        'In edit mode the mesh shortcuts apply.',
        'En el modo de edición valen los atajos de la malla.',
        '在编辑模式下使用网格快捷键。',
      ],
      'Mover a seleção': ['Move the selection', 'Mover la selección', '移动所选'],
      'Girar a seleção': ['Rotate the selection', 'Girar la selección', '旋转所选'],
      'Escalar a seleção': ['Scale the selection', 'Escalar la selección', '缩放所选'],
      'Duplicar a seleção': ['Duplicate the selection', 'Duplicar la selección', '复制所选'],
      'Apagar a seleção': ['Delete the selection', 'Borrar la selección', '删除所选'],
      'Enquadrar a cena': ['Fit the scene', 'Encuadrar la escena', '适应场景'],
      'Ligar ou desligar a grade': [
        'Turn the grid on or off',
        'Activar o desactivar la rejilla',
        '开关网格',
      ],
      'Alternar perspectiva e ortográfica': [
        'Switch perspective and orthographic',
        'Alternar perspectiva y ortográfica',
        '切换透视与正交',
      ],
      ...
      Painéis: ['Panels', 'Paneles', '面板'],
      'Enquadrar a cena (F)': ['Fit the scene (F)', 'Encuadrar la escena (F)', '适应场景 (F)'],
      'Ligar ou desligar a grade (G)': [
        'Turn the grid on or off (G)',
        'Activar o desactivar la rejilla (G)',
        '开关网格 (G)',
      ],
      'Alternar perspectiva e ortográfica (5)': [
        'Switch perspective and orthographic (5)',
        'Alternar perspectiva y ortográfica (5)',
        '切换透视与正交 (5)',
      ],
      'Unidade de medida': ['Unit of measure', 'Unidad de medida', '计量单位'],
      'Modelo do projeto para usar como referência': [
        'Project model to use as reference',
        'Modelo del proyecto para usar como referencia',
        '用作参考的项目模型',
      ],
      'Carregar o modelo escolhido no viewport': [
        'Load the chosen model into the viewport',
        'Cargar el modelo elegido en el viewport',
        '将所选模型载入视口',
      ],
      'Tirar a referência do viewport': [
        'Remove the reference from the viewport',
        'Quitar la referencia del viewport',
        '从视口移除参考',
      ],
      'Cena 3D do modelador': ['Modeler 3D scene', 'Escena 3D del modelador', '建模器 3D 场景'],
      'Nenhuma referência carregada': [
        'No reference loaded',
        'Ninguna referencia cargada',
        '未加载参考',
      ],
      'Carregando referência…': ['Loading reference…', 'Cargando referencia…', '正在加载参考…'],
      'Nenhum modelo 3D no projeto': [
        'No 3D model in the project',
        'Ningún modelo 3D en el proyecto',
        '项目中没有 3D 模型',
      ],
      'WebGL indisponível neste navegador — o viewport do modelador precisa de WebGL.': [
        'WebGL is unavailable in this browser — the modeler viewport needs WebGL.',
        'WebGL no está disponible en este navegador — el viewport del modelador necesita WebGL.',
        '此浏览器不支持 WebGL — 建模器视口需要 WebGL。',
      ],
      'O navegador reiniciou o WebGL — refazendo a cena…': [
        'The browser restarted WebGL — rebuilding the scene…',
        'El navegador reinició WebGL — rehaciendo la escena…',
        '浏览器重启了 WebGL — 正在重建场景…',
      ],
      'Editor fora de alcance — a referência não veio': [
        'Editor out of reach — the reference did not arrive',
        'Editor fuera de alcance — la referencia no llegó',
        '无法连接编辑器 — 参考未到达',
      ],
      'Escolha um projeto para carregar a referência': [
        'Choose a project to load the reference',
        'Elige un proyecto para cargar la referencia',
        '选择一个项目以加载参考',
      ],
      'O Synapse Relay local adiciona terminal, disco e dev server. A URL do Notion é a mesma.': [
        'The local Synapse Relay adds terminal, disk and dev server. The Notion URL stays the same.',
        'El Synapse Relay local añade terminal, disco y dev server. La URL de Notion es la misma.',
        '本地 Synapse Relay 增加终端、磁盘和开发服务器，Notion 地址保持不变。',
      ],
      'O projeto não está mais aberto no editor': [
        'The project is no longer open in the editor',
        'El proyecto ya no está abierto en el editor',
        '项目已在编辑器中关闭',
      ],
      'Este editor não tem o Estúdio 3D carregado': [
        'This editor does not have the 3D Studio loaded',
        'Este editor no tiene el Estudio 3D cargado',
        '此编辑器未加载 3D 工作室',
      ],
      'O arquivo não está mais no projeto': [
        'The file is no longer in the project',
      ...
      'A malha chegou corrompida': [
        'The mesh arrived corrupted',
        'La malla llegó corrupta',
        '网格到达时已损坏',
      ],
      'A travessia da malha ficou incompleta': [
        'The mesh crossing was incomplete',
        'La travesía de la malla quedó incompleta',
        '网格传输不完整',
      ],
      'A malha é grande demais para o viewport': [
        'The mesh is too large for the viewport',
        'La malla es demasiado grande para el viewport',
        '网格对视口来说太大',
      ],
      'A referência falhou': ['The reference failed', 'La referencia falló', '参考加载失败'],
      ...
      'inclusive quando o nó principal deixa de responder antes de processar a chamada': [
        'including when the main node stops responding before it can process the call',
        'incluso cuando el nodo principal deja de responder antes de procesar la llamada',
        '包括主节点在处理调用之前就停止响应的情况',
      ],
      '(Node 18+) · 2) clique em': [
        '(Node 18+) · 2) click',
      ...
      '— situação em que o encaminhamento interno dos nós não chega a funcionar. Informe o endereço do portão acima para que o conector trabalhe sempre com uma única URL estável, sem depender de um nó específico.':
      [
        '— a situation in which the internal forwarding between nodes cannot work. Enter the gateway address above so the connector always works with a single stable URL, without depending on a specific node.',
        '— una situación en la que el reenvío interno entre nodos no puede funcionar. Indica arriba la dirección de la puerta de enlace para que el conector trabaje siempre con una única URL estable, sin depender de un nodo concreto.',
        '——在这种情况下，节点之间的内部转发无法工作。请在上方填写网关地址，让连接器始终使用一个稳定的唯一网址，而不依赖某个特定节点。',
      ],
      ...
      ') NAO esta na lista de nos do portao (': [
        ") is NOT in the gateway's node list (",
        ') NO está en la lista de nodos de la puerta (',
        '）不在网关的节点列表中（',
      ],
      ...
      ') — a URL unica pode estar fora; confira o endereco informado.': [
        ') — the single URL may be down; check the address you entered.',
        ') — la URL única puede estar caída; revisa la dirección indicada.',
        '）——唯一网址可能已下线；请检查填写的地址。',
      ],
      ') — preview via relay:': [
      ...
      '). As chamadas podem cair num no sem catalogo e mostrar 0 ferramentas. Ajuste a lista de nos do portao ou abra o site com ?relay=':
      [
        '). Calls may land on a node with no catalog and show 0 tools. Adjust the gateway node list or open the site with ?relay=',
        '). Las llamadas pueden caer en un nodo sin catálogo y mostrar 0 herramientas. Ajusta la lista de nodos de la puerta o abre el sitio con ?relay=',
        '）。调用可能落到一个没有目录的节点，因此只显示 0 个工具。请调整网关的节点列表，或使用 ?relay= ' +
        '打开站点',
      ],
      ...
      'Abrir em tela cheia': ['Open fullscreen', 'Abrir en pantalla completa', '全屏打开'],
      'App Synapse Relay detectado.': [
        'Synapse Relay app detected.',
        'App Synapse Relay detectada.',
        '已检测到 Synapse Relay 应用。',
      ],
      'Ative o MCP, copie a URL e cole no conector do Notion.': [
        'Turn on MCP, copy the URL and paste it into the Notion connector.',
        'Activa el MCP, copia la URL y pégala en el conector de Notion.',
        '启用 MCP，复制该地址并粘贴到 Notion 连接器。',
      ],
      'Ative o MCP, copie a URL e cole no conector do Notion. Mantenha esta aba aberta.': [
        'Turn on MCP, copy the URL and paste it into the Notion connector. Keep this tab open.',
        'Activa el MCP, copia la URL y pégala en el conector de Notion. Mantén esta pestaña abierta.',
        '启用 MCP，复制该地址并粘贴到 Notion 连接器。请保持此标签页打开。',
      ],
      'Avançado': ['Advanced', 'Avanzado', '高级'],
      ...
      'Comandos permitidos (um por linha)': [
        'Allowed commands (one per line)',
        'Comandos permitidos (uno por línea)',
        '允许的命令（每行一个）',
      ],
      ...
      'Endereço do Synapse Relay': [
        'Synapse Relay address',
        'Dirección de Synapse Relay',
        'Synapse Relay 地址',
      ],
      ...
      'Execute node relay.js, clique em Testar e marque a permissão do terminal.': [
        'Run node relay.js, click Test and enable the terminal permission.',
        'Ejecuta node relay.js, pulsa Probar y activa el permiso del terminal.',
        '运行 node relay.js，点击测试并勾选终端权限。',
      ],
      Failover: ['Failover', 'Failover', '故障转移'],
      ...
      'Nós de reserva': ['Backup nodes', 'Nodos de reserva', '备用节点'],
      Nuvem: ['Cloud', 'Nube', '云端'],
      ...
      'O portão é um roteador de entrada que mantém a URL única sempre disponível. Com o portão configurado, a URL do servidor MCP passa a ser a dele: cada chamada entra por ali e é encaminhada na hora para o primeiro nó ativo,':
      [
        'The gateway is an entry router that keeps the single URL always available. With the gateway configured, the MCP server URL becomes the gateway URL: every call comes in through it and is forwarded right away to the first active node,',
        'La puerta de enlace es un router de entrada que mantiene la URL única siempre disponible. Con la puerta configurada, la URL del servidor MCP pasa a ser la suya: cada llamada entra por ahí y se reenvía al instante al primer nodo activo,',
        '网关是一个入口路由器，可让唯一网址始终保持可用。配置网关后，MCP 服务器网址就变成网关的网址：每个调用都从这里进入，并立即转发到第一个可用节点，',
      ],
      ...
      'Permitir comandos no terminal': [
        'Allow terminal commands',
        'Permitir comandos en el terminal',
        '允许终端命令',
      ],
      ...
      'Portão da URL única': ['Single URL gateway', 'Puerta de la URL única', '单一地址网关'],
      ...
      'Portão da URL única — failover completo mesmo se o nó principal parar (recomendado)': [
        'Single-URL gateway — full failover even if the main node stops (recommended)',
        'Puerta de enlace de URL única: failover completo incluso si el nodo principal se detiene (recomendado)',
        '单一网址网关——即使主节点停止也能完全故障转移（推荐）',
      ],
      ...
      'Sair da tela cheia': ['Exit fullscreen', 'Salir de pantalla completa', '退出全屏'],
      ...
      'Serviço local não encontrado — execute node relay.js e clique em Testar.': [
        'Local service not found — run node relay.js and click Test.',
        'Servicio local no encontrado: ejecuta node relay.js y pulsa Probar.',
        '未找到本地服务——请运行 node relay.js 并点击测试。',
      ],
      'Serviço local sem resposta — reconectando.': [
        'Local service not responding — reconnecting.',
        'El servicio local no responde: reconectando.',
        '本地服务无响应——正在重新连接。',
      ],
      ...
      'Modele em 3D': ['Model in 3D', 'Modela en 3D', '3D 建模'],
      'Modelador 3D dentro do projeto': [
        '3D modeler inside the project',
        'Modelador 3D dentro del proyecto',
        '项目内的 3D 建模器',
      ],
      'Abre o modelador em outra aba e cria o asset dentro do projeto: primitiva, malha editável, material, UV e exportação em .glb. Tem folha de atalhos, mapa de teclas estilo Blender e camada de toque para o celular — e a IA usa as mesmas ferramentas.':
      [
        'Opens the modeler in another tab and creates the asset inside the project: primitive, editable mesh, material, UV and .glb export. It has a shortcut sheet, a Blender-style keymap and a touch layer for the phone — and the AI uses the same tools.',
        'Abre el modelador en otra pestaña y crea el asset dentro del proyecto: primitiva, malla editable, material, UV y exportación en .glb. Tiene hoja de atajos, mapa de teclas estilo Blender y capa táctil para el móvil — y la IA usa las mismas herramientas.',
        '在另一个标签页打开建模器，在项目内创建资产：基本体、可编辑网格、材质、UV 和 .glb 导出。还有快捷键表、Blender 风格按键映射和手机触控层 —— AI 使用同样的工具。',
      ],
      ...
      'URL do relay': ['Relay URL', 'URL del relay', 'relay 地址'],
      ...
      'URL do servidor MCP': ['MCP server URL', 'URL del servidor MCP', 'MCP 服务器地址'],
      ...
      'URL pública do túnel': ['Public tunnel URL', 'URL pública del túnel', '隧道公网地址'],
      ...
      'Um endereço por linha, em ordem de prioridade. Enquanto o nó principal está no ar, ele mesmo encaminha cada chamada ao próximo endereço da lista ao atingir o limite de capacidade, sem alterar a URL configurada no Notion. Para manter o conector disponível também quando o nó principal deixa de responder antes de processar a chamada, informe o portão da URL única abaixo.':
      [
        'One address per line, in priority order. While the main node is up, it forwards each call to the next address on the list once it reaches the capacity limit, without changing the URL configured in Notion. To keep the connector available even when the main node stops responding before it can process the call, enter the single-URL gateway below.',
        'Una dirección por línea, en orden de prioridad. Mientras el nodo principal está activo, él mismo reenvía cada llamada a la siguiente dirección de la lista al alcanzar el límite de capacidad, sin cambiar la URL configurada en Notion. Para mantener el conector disponible incluso cuando el nodo principal deja de responder antes de procesar la llamada, indica abajo la puerta de enlace de URL única.',
        '每行一个地址，按优先级排序。主节点在线时，它会在达到容量上限后自行把每个调用转发到列表中的下一个地址，无需更改在 Notion 中配置的网址。若希望主节点在处理调用前停止响应时连接器仍然可用，请在下方填写唯一网址网关。',
      ],
      ...
      'terminal e disco': ['terminal and disk', 'terminal y disco', '终端与磁盘'],
      ...
      'Blepse 3D': ['Blepse 3D', 'Blepse 3D', 'Blepse 3D'],
      'fase 2': ['phase 2', 'fase 2', '阶段 2'],
      'Modelador 3D (fase 2: cubo no projeto)': [
        '3D Modeler (phase 2: cube into the project)',
        'Modelador 3D (fase 2: cubo en el proyecto)',
        '3D 建模器（阶段 2：把立方体写入项目）',
      ],
      'Procurando o editor…': ['Looking for the editor…', 'Buscando el editor…', '正在寻找编辑器…'],
      'Conectado ao editor': ['Connected to the editor', 'Conectado al editor', '已连接到编辑器'],
      'Editor fora do ar — reconectando…': [
        'Editor is down — reconnecting…',
        'Editor caído — reconectando…',
        '编辑器不可用 — 正在重连…',
      ],
      'Projeto de destino': ['Target project', 'Proyecto de destino', '目标项目'],
      'Atualizar lista': ['Refresh list', 'Actualizar lista', '刷新列表'],
      'Nenhum projeto aberto no editor': [
        'No project open in the editor',
        'Ningún proyecto abierto en el editor',
        '编辑器中没有打开的项目',
      ],
      'Viewport reservado': ['Viewport reserved', 'Viewport reservado', '视口已预留'],
      'A cena 3D chega na fase 3. Esta fase entrega a travessia do arquivo e a gravação do .glb no projeto, pela porta única do editor.':
      [
        'The 3D scene arrives in phase 3. This phase delivers the file crossing and the .glb write into the project, through the single write door of the editor.',
        'La escena 3D llega en la fase 3. Esta fase entrega la travesía del archivo y la escritura del .glb en el proyecto, por la puerta única del editor.',
        '3D 场景将在阶段 3 到来。本阶段交付文件传输，并通过编辑器唯一的写入通道把 .glb 写入项目。',
      ],
      Transporte: ['Transport', 'Transporte', '传输通道'],
      Sessão: ['Session', 'Sesión', '会话'],
      Protocolo: ['Protocol', 'Protocolo', '协议'],
      Projetos: ['Projects', 'Proyectos', '项目'],
      Atualizado: ['Updated', 'Actualizado', '更新于'],
      'Blepse 3D aberto': ['Blepse 3D opened', 'Blepse 3D abierto', 'Blepse 3D 已打开'],
      'Aba, canal e gravação no projeto': [
        'Tab, channel and writing into the project',
        'Pestaña, canal y escritura en el proyecto',
        '标签页、通道与项目写入',
      ],
      'Cubo paramétrico': ['Parametric cube', 'Cubo paramétrico', '参数化立方体'],
      'Largura (m)': ['Width (m)', 'Ancho (m)', '宽度（米）'],
      'Altura (m)': ['Height (m)', 'Alto (m)', '高度（米）'],
      'Profundidade (m)': ['Depth (m)', 'Profundidad (m)', '深度（米）'],
      'Nome do arquivo': ['File name', 'Nombre del archivo', '文件名'],
      'Sobrescrever se já existir': [
        'Overwrite if it already exists',
        'Sobrescribir si ya existe',
        '若已存在则覆盖',
      ],
      'Gravar no projeto': ['Write to the project', 'Guardar en el proyecto', '写入项目'],
      'Nada gravado ainda': ['Nothing written yet', 'Nada guardado todavía', '尚未写入任何内容'],
      'Gravando no projeto…': [
        'Writing to the project…',
        'Guardando en el proyecto…',
        '正在写入项目…',
      ],
      'Enviando bloco': ['Sending block', 'Enviando bloque', '正在发送数据块'],
      Gravado: ['Written', 'Guardado', '已写入'],
      'Editor fora de alcance — nada foi gravado': [
        'Editor out of reach — nothing was written',
        'Editor fuera de alcance — no se guardó nada',
        '编辑器不可达 — 未写入任何内容',
      ],
      ...
      'O editor não respondeu a tempo — nada foi gravado': [
        'The editor did not answer in time — nothing was written',
        'El editor no respondió a tiempo — no se guardó nada',
        '编辑器未及时响应 — 未写入任何内容',
      ],
      'Este editor não tem a porta de gravação': [
        'This editor has no write door',
        'Este editor no tiene la puerta de escritura',
        '此编辑器没有写入通道',
      ],
      'O projeto escolhido não está mais aberto no editor': [
        'The chosen project is no longer open in the editor',
        'El proyecto elegido ya no está abierto en el editor',
        '所选项目已不在编辑器中打开',
      ],
      'Nome de arquivo inválido': ['Invalid file name', 'Nombre de archivo inválido', '文件名无效'],
      'Já existem arquivos demais com esse nome': [
        'There are already too many files with that name',
        'Ya hay demasiados archivos con ese nombre',
        '同名文件已经太多',
      ],
      'Modelo grande demais para atravessar': [
        'Model too large to cross over',
        'Modelo demasiado grande para cruzar',
        '模型过大，无法传输',
      ],
      'Arquivo travado por outro agente': [
        'File locked by another agent',
        'Archivo bloqueado por otro agente',
        '文件被其他代理锁定',
      ],
      'O arquivo chegou corrompido — nada foi gravado': [
        'The file arrived corrupted — nothing was written',
        'El archivo llegó dañado — no se guardó nada',
        '文件在传输中损坏 — 未写入任何内容',
      ],
      'A travessia ficou incompleta — nada foi gravado': [
        'The crossing was incomplete — nothing was written',
        'La travesía quedó incompleta — no se guardó nada',
        '传输不完整 — 未写入任何内容',
      ],
      'Não foi possível montar o .glb': [
        'The .glb could not be assembled',
        'No se pudo montar el .glb',
        '无法生成 .glb',
      ],
      'A gravação falhou': ['The write failed', 'La escritura falló', '写入失败'],
      'A aba não pôde ser montada': [
        'The tab could not be built',
        'La pestaña no pudo montarse',
        '无法构建标签页',
      ],
    };
    ...
    const EXTRA = {
      ...
      'O encaminhamento interno depende do proprio no indisponivel. A sessao esta preservada no no de reserva':
      [
        'The internal forwarding depends on the unavailable node itself. The session is preserved on the standby node',
        'El reenvío interno depende del propio nodo no disponible. La sesión se conserva en el nodo de reserva',
        '内部转发依赖于已不可用的节点本身。会话已保留在备用节点上',
      ],
      ...
      'Sem portao: o failover em URL unica cobre limite de capacidade, mas nao cobre a indisponibilidade do no principal (a URL cai junto). Informe o endereco do portao no campo acima.':
      [
        'Without a gateway: single-URL failover covers capacity limits but does not cover the ' +
        'main node becoming unavailable (the URL goes down with it). Enter the gateway ' +
        'address in the field above.',
        'Sin puerta: el failover de URL única cubre el límite de capacidad, pero no cubre la ' +
        'indisponibilidad del nodo principal (la URL cae con él). Indica la dirección de la ' +
        'puerta en el campo de arriba.',
        '无网关：单一 URL 故障转移可应对容量上限，但无法应对主节点不可用的情况（URL 会一起失效）。请在上方填写网关地址。',
      ],
    ...
    function keepEdgeWhitespace(source, translated) {
      ...
      return leading + String(translated).replace(/^\s+|\s+$/g, '') + trailing;
    }
    ...
    function bruto(s, i) {
      ...
      if (c !== s) {
        e = D[c];
        if (e && e[i]) return keepEdgeWhitespace(s, e[i]);
      }
      if (!c) return null;
      indexar();
      const k = NORM[chave(c)];
      if (k && D[k] && D[k][i]) return keepEdgeWhitespace(s, ajustar(c, D[k][i]));
      if (/\d/.test(c)) {
        ...
        if (kk && D[kk] && D[kk][i]) {
          ...
          if (nums.length && nums.length === alvoNums.length) {
            ...
            return keepEdgeWhitespace(s, out);
          }
        }
      }
      return null;
    ...
    const EDGE_SPACES = /^(\s*)([\s\S]*?)(\s*)$/;

    function translateKeepingEdgeSpaces(s, i) {
      const parts = s.match(EDGE_SPACES);
      if (!parts || !parts[2]) return calc(s, i);
      return parts[1] + calc(parts[2], i) + parts[3];
    }
    ...
    function tr(s) {
      ...
      const r = translateKeepingEdgeSpaces(s, i);
      if (nmemo > 12000) {
...
#langMenu button.sel{color:var(--acc,#7aa2f7)}#langMenu button.sel .cod{opacity:1}`;
    ...
    function registerPhrases(phrases) {
      ...
      for (let phrase in phrases) {
        if (phrase in D) continue;
        const translations = phrases[phrase];
        if (!Array.isArray(translations) || translations.length !== 3) continue;
        D[phrase] = translations;
        addedCount++;
      }
